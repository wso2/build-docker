...
RUN \
    wget -P /build/software/java https://github.com/adoptium/temurin21-binaries/releases/download/jdk-21.0.3%2B9/OpenJDK21U-jdk_x64_linux_hotspot_21.0.3_9.tar.gz \
    && tar -xvzf /build/software/java/OpenJDK21U-jdk_x64_linux_hotspot_21.0.3_9.tar.gz --directory /build/software/java \
    && rm /build/software/java/OpenJDK21U-jdk_x64_linux_hotspot_21.0.3_9.tar.gz
...
RUN wget -P /build/software/go https://dl.google.com/go/go1.22.8.linux-amd64.tar.gz \
    && tar -xzf /build/software/go/go1.22.8.linux-amd64.tar.gz --directory /build/software/go && mv /build/software/go/go /build/software/go/go-1.22 && rm /build/software/go/go1.22.8.linux-amd64.tar.gz
...
ENV PATH $GOPATH/bin:/build/software/go/go-1.22/bin:$PATH
...
COPY OpenJDK11U-jdk_x64_linux_hotspot_11.0.22_7.tar.gz /build/software/java

RUN \
    tar -xvzf /build/software/java/OpenJDK11U-jdk_x64_linux_hotspot_11.0.22_7.tar.gz --directory /build/software/java \
    && rm /build/software/java/OpenJDK11U-jdk_x64_linux_hotspot_11.0.22_7.tar.gz

ENV JAVA_HOME /build/software/java/jdk-11.0.22+7
